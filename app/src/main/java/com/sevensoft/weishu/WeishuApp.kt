...
import com.sevensoft.weishu.di.appModule
import com.sevensoft.weishu.di.dataSourceModule
import com.sevensoft.weishu.di.repositoryModule
import com.sevensoft.weishu.di.viewModelModule
...
import com.sevensoft.weishu.data.sync.RestoreFailedException
...
import com.sevensoft.weishu.utils.DatabaseUtil
...
private const val TAG = "WeishuApp"

const val CHAT_COMPLETED_NOTIFICATION_CHANNEL_ID = "chat_completed"
const val CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID = "chat_live_update"
const val WEB_SERVER_NOTIFICATION_CHANNEL_ID = "web_server"

class WeishuApp : Application() {
    override fun onCreate() {
        ...
        try {
            val restored = runBlocking(Dispatchers.IO) {
                BackupManager.applyPendingRestore(this@WeishuApp, JsonInstant)
            }
            if (restored) {
        ...
        get<AppScope>().launch {
            runCatching {
                ...
                if (settings.webServerEnabled) {
                    ...
                    val intent = Intent(this@WeishuApp, WebServerService::class.java).apply {
