package com.sevensoft.weishu.data.datastore
...
import com.sevensoft.weishu.data.ai.mcp.McpServerConfig
import com.sevensoft.weishu.data.ai.prompts.DEFAULT_COMPRESS_PROMPT
import com.sevensoft.weishu.data.ai.prompts.DEFAULT_OCR_PROMPT
import com.sevensoft.weishu.data.ai.prompts.DEFAULT_SUGGESTION_PROMPT
import com.sevensoft.weishu.data.ai.prompts.DEFAULT_TITLE_PROMPT
import com.sevensoft.weishu.data.ai.prompts.DEFAULT_TRANSLATION_PROMPT
import com.sevensoft.weishu.data.ai.prompts.LEARNING_MODE_PROMPT
import com.sevensoft.weishu.asr.ASRProviderSetting
import com.sevensoft.weishu.data.datastore.migration.PreferenceStoreV1Migration
import com.sevensoft.weishu.data.datastore.migration.PreferenceStoreV2Migration
import com.sevensoft.weishu.data.datastore.migration.PreferenceStoreV3Migration
import com.sevensoft.weishu.data.model.Assistant
import com.sevensoft.weishu.data.model.Avatar
import com.sevensoft.weishu.data.model.InjectionPosition
import com.sevensoft.weishu.data.model.Lorebook
import com.sevensoft.weishu.data.model.PromptInjection
import com.sevensoft.weishu.data.model.QuickMessage
import com.sevensoft.weishu.data.model.Tag
import com.sevensoft.weishu.data.sync.s3.S3Config
import com.sevensoft.weishu.ui.theme.CustomTheme
import com.sevensoft.weishu.ui.theme.PresetThemes
import com.sevensoft.weishu.utils.JsonInstant
import com.sevensoft.weishu.utils.toMutableStateFlow
import com.sevensoft.weishu.search.SearchCommonOptions
import com.sevensoft.weishu.search.SearchServiceOptions
import com.sevensoft.weishu.tts.provider.TTSProviderSetting
...
data class WebDavConfig(
    ...
    val username: String = "",
    val password: String = "",
    val path: String = "weishu_backups",
...
private val DEEPSEEK_REASONING_LEVELS = listOf(
    ReasoningLevel.OFF,
    ReasoningLevel.LOW,
    ReasoningLevel.HIGH,
    ReasoningLevel.MAX,
...
/** 找到包含指定模型的提供商 */
fun Settings.findProviderOfModel(modelId: Uuid?): ProviderSetting? {
    if (modelId == null) return null
    return providers.firstOrNull { provider -> provider.models.any { it.id == modelId } }
}

/**
 * 该提供商支持的思考级别。
 * DeepSeek 按官方文档只支持 low/high/max 三档，因此这里限定可选档位。
 */
fun ProviderSetting.reasoningLevels(): List<ReasoningLevel> {
    val baseUrl = when (this) {
        is ProviderSetting.OpenAI -> baseUrl
        is ProviderSetting.Google -> baseUrl
        is ProviderSetting.Claude -> baseUrl
    }
    return if (baseUrl.contains("deepseek", ignoreCase = true)) {
