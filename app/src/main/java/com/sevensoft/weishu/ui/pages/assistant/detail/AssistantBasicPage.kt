...
import com.sevensoft.weishu.ui.components.ai.ReasoningButton
...
import com.sevensoft.weishu.ui.components.ui.TagsInput
import com.sevensoft.weishu.ui.components.ui.UIAvatar
import com.sevensoft.weishu.ui.hooks.heroAnimation
import com.sevensoft.weishu.ui.theme.CustomColors
import com.sevensoft.weishu.utils.toFixed
...
import com.sevensoft.weishu.data.model.Tag as DataTag
...
internal fun AssistantBasicContent(
    ...
    assistant: Assistant,
    providers: List<com.sevensoft.weishu.ai.provider.ProviderSetting>,
    tags: List<DataTag>,
        ...
        Card(
            ...
            FormItem(
                ...
                ReasoningButton(
                    ...
                    levels = providers.firstOrNull { provider ->
                        provider.models.any { it.id == assistant.chatModelId }
                    }?.reasoningLevels() ?: ReasoningLevel.entries,
