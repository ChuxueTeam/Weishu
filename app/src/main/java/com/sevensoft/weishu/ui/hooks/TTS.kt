...
import com.sevensoft.weishu.tts.model.PlaybackState
...
private class CustomTtsStateImpl(
    ...
    private val controller by lazy { com.sevensoft.weishu.tts.controller.TtsController(context, ttsManager) }
