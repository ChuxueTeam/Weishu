/**
 * Display settings
 * @see app/src/main/java/com/sevensoft/weishu/data/datastore/PreferencesStore.kt - DisplaySetting
 */
 ...
 * @see app/src/main/java/com/sevensoft/weishu/data/datastore/PreferencesStore.kt - Settings
 */
