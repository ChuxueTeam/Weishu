package com.sevensoft.weishu.tts.provider

import android.content.Context
import kotlinx.coroutines.flow.Flow
import com.sevensoft.weishu.tts.model.AudioChunk
import com.sevensoft.weishu.tts.model.TTSRequest
import com.sevensoft.weishu.tts.provider.providers.ElevenLabsTTSProvider
import com.sevensoft.weishu.tts.provider.providers.FishAudioTTSProvider
import com.sevensoft.weishu.tts.provider.providers.GeminiTTSProvider
import com.sevensoft.weishu.tts.provider.providers.GroqTTSProvider
import com.sevensoft.weishu.tts.provider.providers.MiMoTTSProvider
import com.sevensoft.weishu.tts.provider.providers.MiniMaxTTSProvider
import com.sevensoft.weishu.tts.provider.providers.OpenAITTSProvider
import com.sevensoft.weishu.tts.provider.providers.QwenTTSProvider
import com.sevensoft.weishu.tts.provider.providers.StepTTSProvider
import com.sevensoft.weishu.tts.provider.providers.SystemTTSProvider
import com.sevensoft.weishu.tts.provider.providers.VolcengineTTSProvider
import com.sevensoft.weishu.tts.provider.providers.XAITTSProvider
